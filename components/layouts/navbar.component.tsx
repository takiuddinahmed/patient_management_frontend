...
const Navbar = () => {
  return (
    <>
      ...
      <nav className="flex items-center justify-start  flex-wrap p-6 bg-cyan-600">
        ...
        <div className="block lg:hidden">
          <button
            className="flex justify-right items-center px-3 py-2 border rounded text-teal-200 border-teal-400 hover:text-white hover:border-white">
            <svg
        ...
        <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
          ...
          <div className="avatar placeholder  px-3 py-0">
            <div className="bg-white text-gray-400 rounded-full w-10">
              <span>MX</span>
            </div>
          </div>
